...
extension UserDefaults {
    ...
    public static var personId: Int? {
        get {
            let userDefaults = UserDefaults.standard
            return userDefaults.integer(forKey: "personId")
        }
        set {
            let userDefaults = UserDefaults.standard
            if let hasValue = newValue {
                userDefaults.set(hasValue, forKey: "personId")
            } else {
                userDefaults.removeObject(forKey: "personId")
            }
    ...
    public static var email: String? {
        ...
        set {
            let userDefaults = UserDefaults.standard
            if let hasValue = newValue {
                userDefaults.set(hasValue, forKey: "email")
            } else {
